...
import { Checkbox, Button, Grid, Box, Typography } from '@mui/material';
...
const SettingsComponent: React.FC = () => {
    ...
    return (
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1, paddingLeft: '80px', paddingRight: '20px', paddingBottom: '60px' }}>
            ...
            <Button type="submit" variant="contained" sx={{ padding: '20px 50px', color: '#FFF', background: '#0098C6', border: '0', boxShadow: '0' }}>
                Save
            </Button>
        </Box>
    );
